...
public class UserTest2 {
	...
	public void createUesrs()
	{
		...
		Response r=UserEndpoint2.createUser(u);
	...
	{
//		l.info("Get the User");
		Response r=UserEndpoint2.getUser(this.u.getUsername());
	...
	public void UpdateUesrs()
	{
		...
		Response r=UserEndpoint2.updateUser(this.u.getUsername(), u);
		Response r1=UserEndpoint2.getUser(this.u.getUsername());
		r1.then().log().body();
	...
	public void deleteUsers()
	{
		...
		Response r=UserEndpoint2.deleteUser(this.u.getUsername());
